    ...
    <body>
        ...
        <div class="navbar">
            ...
            <div class="navbar__content__mobile">
                <span class="navbar__content__mobile__close"
                    ><i class="bx bx-window-close"></i
                ></span>
                <a href="index.php" class="navbar__content__mobile__logo"
                    ><img src="./access/imgs/logo.png" alt=""
                /></a>
                <form
                    action=""
                    method="get"
                    class="navbar__content__mobile__search"
                >
                    <input
                        type="text"
            ...
            <div class="navbar__item search">
                <form action="" method="GET" class="navbar__item__search">
                    <input
                        ...
                        class="navbar__item__search-input"
                        id=""
                    />
